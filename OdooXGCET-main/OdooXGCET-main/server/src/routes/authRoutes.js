...
router.get('/employees/view', authenticate, authController.getAllEmployeesView); // All authenticated users can view
...
router.get('/employees', authenticate, authorizeHR, authController.getAllEmployees); // HR only - full details
